...
model1=load_model(r'C:\Users\Asus\Desktop\My PG Project\FinalYear Project - copy\Final Project\Model\body.h5')
model2=load_model(r'C:\Users\Asus\Desktop\My PG Project\FinalYear Project - copy\Final Project\Model\level.h5')
model3=load_model(r'C:\Users\Asus\Desktop\My PG Project\FinalYear Project - copy\Final Project\Model\car.h5',compile=False)
...
def afterforgot():
    ...
    if user in my_database:
        ...
        hashed_psw = generate_password_hash(passw1, method='sha256')
...
def send_email(user, passw1):
    ...
    server.starttls()
    server.login('mohamedusman1321@gmail.com', 'etpwrbjiutzytggv')
    ...
    server.sendmail('mohamedusman1321@gmail.com', user, message)
    server.quit()
