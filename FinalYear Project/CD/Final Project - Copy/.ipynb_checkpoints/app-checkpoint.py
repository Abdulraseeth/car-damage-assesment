...
client = Cloudant.iam('03f42f3d-318d-4956-9391-355928d41415-bluemix', '5-c34E2Xb7P0Yuc7hSrVT-HMDr2hbEJ4CYirMUvQz425', connect=True)
...
def afterreg():
    ...
    hashed_psw = generate_password_hash(x[2], method='sha256')
